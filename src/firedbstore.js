...
export const uservisit =async(type)=>{
  ...
  // const date = fireDb.Timestamp.now().toDate().toString();
  //console.log(res.data.IPv4);
    fireDb.auth().signInAnonymously().then((response)=>{
      ...
      ref2.set({
          id:db,
          AlgoAddress:localStorage.getItem("walletAddress"),WalletType:type,ipAddress:res.data.IPv4,TimeStamp:dateset
      })
      .then(()=>{             
...
// export const Registeruser =async(type,algoAmount)=>{
//   let datavalues=[];
//   const res = await axios.get('https://geolocation-db.com/json/')
...
//   //console.log(res.data.IPv4);
//     fireDb.auth().signInAnonymously().then((response)=>{
//       let ref2=fireDb.database().ref(`Registeruser/${localStorage.getItem("walletAddress")}`);                    
//       const db = ref2.push().key;
//       let dateset=new Date().toDateString();  
//       ref2.set({
//           id:db,
//           AlgoAddress:localStorage.getItem("walletAddress"),Commitamount:algoAmount,TimeStamp:dateset
//       })
//       .then(()=>{             
//        //console.log("Uservisits updated")
//       }).catch((err) => {                                                        
