                ...
                <Row className='justify-content-center'>
                    <Col md={10} lg={7}>
                        <Card className='card-dash border-0 d-block'>
                            <div>
                                <h3 className='mb-1'>BSC Artists</h3>
                                <p>Create artist</p>
                            </div>
                            <hr className='my-4' />
                            ...
                            <Form>
                                <div className='mb-3'>
                                    ...
                                    {getIProfile === "" || getIProfile === undefined || getIProfile === null || getIProfile[0] === "" || getIProfile[0] === undefined || getIProfile[0] === null ? (
                                        ...
                                        <input type="text" id="inputID" value={UserName}  placeholder='Enter the artist name' className="form-control form-control-field border-0" onChange={event => setUserName( event.target.value)}/>
                                    )}
