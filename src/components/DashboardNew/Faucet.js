                                ...
                                <Tab eventKey="bond" title="ELEM Faucet">
                                    <Row className='row-divider'>
                                        ...
                                        <Col md={12}>
                                            ...
                                            <Row className='flex-nowrap align-items-center mb-2 gx-3'>
                                                <Col xs="auto">
                                                    {elemAssetOpt === false ? <ButtonLoad loading={loaderAssetOpt} className='btn w-100 btn-blue' onClick={() => elemWalletCheck()}>
                                                        ELEM Asset Optin
                                                    </ButtonLoad> : <><Button disabled className='btn w-100 btn-blue'>
                                                        ELEM Asset Opted
                                                    </Button></> }
                                                ...
                                                <Col>
                                                {elemAssetOpt == true ? <ButtonLoad loading={loaderUsdcFund} className='btn w-20 btn-blue' onClick={() => elemFundWalletCheck()}>
                                                        Dispense 
                                                    </ButtonLoad> : <Button disabled className='btn w-20 btn-blue'>
                                                        Dispense
                                                    </Button>}
                                ...
                                <Tab eventKey="bond" title="TAU Faucet">
                                    <Row className='row-divider'>
                                        ...
                                        <Col md={12}>
                                            ...
                                            <Row className='flex-nowrap align-items-center mb-2 gx-3'>
                                                <Col xs="auto">
                                                    {tauAssetOpt === false ? <ButtonLoad loading={loaderAssetOpt} className='btn w-100 btn-blue' onClick={() => tauWalletCheck()}>
                                                        TAU Asset Optin
                                                    </ButtonLoad> : <><Button disabled className='btn w-100 btn-blue'>
                                                        TAU Asset Opted
                                                    </Button></> }
                                                ...
                                                <Col>
                                                {tauAssetOpt == true ? <ButtonLoad loading={loaderUsdcFund} className='btn w-20 btn-blue' onClick={() => tauFundWalletCheck()}>
                                                        Dispense 
                                                    </ButtonLoad> : <Button disabled className='btn w-20 btn-blue'>
                                                        Dispense
                                                    </Button>}
                                ...
                                <Tab eventKey="bond" title="EINR Faucet">
                                    <Row className='row-divider'>
                                        ...
                                        <Col md={12}>
                                            ...
                                            <Row className='flex-nowrap align-items-center mb-2 gx-3'>
                                                <Col xs="auto">
                                                    {einrAssetOpt === false ? <ButtonLoad loading={loaderAssetOpt} className='btn w-100 btn-blue' onClick={() => einrWalletCheck()}>
                                                        EINR Asset Optin
                                                    </ButtonLoad> : <><Button disabled className='btn w-100 btn-blue'>
                                                        EINR Asset Opted
                                                    </Button></> }
                                                ...
                                                <Col>
                                                {einrAssetOpt == true ? <ButtonLoad loading={loaderUsdcFund} className='btn w-20 btn-blue' onClick={() => einrFundWalletCheck()}>
                                                        Dispense 
                                                    </ButtonLoad> : <Button disabled className='btn w-20 btn-blue'>
                                                        Dispense
                                                    </Button>}
                                ...
                                <Tab eventKey="bond" title="USDT Faucet">
                                    <Row className='row-divider'>
                                        ...
                                        <Col md={12}>
                                            ...
                                            <Row className='flex-nowrap align-items-center mb-2 gx-3'>
                                                <Col xs="auto">
                                                    {usdtAssetOpt === false ? <ButtonLoad loading={loaderAssetOpt} className='btn w-100 btn-blue' onClick={() => usdtWalletCheck()}>
                                                        USDT Asset Optin
                                                    </ButtonLoad> : <><Button disabled className='btn w-100 btn-blue'>
                                                        USDT Asset Opted
                                                    </Button></> }
                                                ...
                                                <Col>
                                                {usdtAssetOpt == true ? <ButtonLoad loading={loaderUsdcFund} className='btn w-20 btn-blue' onClick={() => usdtFundWalletCheck()}>
                                                        Dispense 
                                                    </ButtonLoad> : <Button disabled className='btn w-20 btn-blue'>
                                                        Dispense
                                                    </Button>}
