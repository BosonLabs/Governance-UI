...
const optinModal = () =>
{
    ...
    {
    if(appOpt === false || assetUsdcOpt === false || assetElemOpt === false)
    {
...
const recollateralizeWalletCheck = async () =>
{
    if(localStorage.getItem("walletName") === "myAlgoWallet")
    {
            ...
            <div className="d-flex align-items-center float-end mt-1 acc-h-links mb-4">
                ...
                <div className="group-row">
                    <Row>
                        ...
                        <Col sm={7}>
                            <div className="input-group-max px-3 input-group-max-lg w-100">                               
                                <input type="number" placeholder='0.00' value={(((parseFloat(usdcAmount) * usdcPrice) * (1 + (elemPrice * (bonusRate/100)))/elemPrice).toFixed(6))} readonly disabled className='form-control' />
                            </div>
                        </Col>
                    </Row>
                </div>
                ...
                <ButtonLoad loading={loader} className='btn w-100 btn-blue mb-20' onClick={recollateralizeWalletCheck}>
                Recollateralize
                </ButtonLoad>
